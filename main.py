# Tousif Anwar Student ID: 001299747
...
def display_package_query(ht, package_id, report_datetime):
    ...
    if package_id == 9 and report_timedelta < timedelta(hours=10, minutes=20):
        package.delivery_address = "Wrong address listed"
    elif package_id == 9:
    ...
    package_info_status += "\tAssigned Truck: " + str(package.assigned_truck_id if package.assigned_truck_id else "Not assigned")
    package_info_status += "\tSpecial Notes: " + package.special_notes if package.special_notes else " No Special Notes"
